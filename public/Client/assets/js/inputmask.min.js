        ...
        var e = {
                ...
                9845: function (e, t, i) {
                    ...
                    var r =
                        ...
                        s =
                            (n.default.navigator &&
                                n.default.navigator.maxTouchPoints) ||
                    ...
                    var f = {
                        keydownEvent: function (e, t, i, c, u) {
                            ...
                            if (
                                ...
                                e.preventDefault();
                                var x = a.seekNext.call(
                                    p,
                                    a.getLastValidPosition.call(p)
                                );
                                a.caret.call(
                                    p,
                                    m,
                                    e.shiftKey ? y.begin : x,
                                    x,
                                    !0
                                );
                            } else
                                (k === n.keys.Home && !e.shiftKey) ||
                                k === n.keys.PageUp
                                    ? (e.preventDefault(),
                                      a.caret.call(
                                          p,
                                    ...
                                    ? !0 === d.tabThrough && k === n.keys.Tab
                                        ? !0 === e.shiftKey
                                            ? ((y.end = a.seekPrevious.call(
                                                  p,
                                                  y.end,
                                                  !0
                                              )),
                                              !0 ===
                                                  l.getTest.call(p, y.end - 1)
                                                      .match.static && y.end--,
                                              (y.begin = a.seekPrevious.call(
                                                  p,
                                                  y.end,
                                                  !0
                                              )),
                                            ...
                                            : ((y.begin = a.seekNext.call(
                                                  p,
                                                  y.begin,
                                                  !0
                                              )),
                                              (y.end = a.seekNext.call(
                                                  p,
                                                  y.begin,
                                                  !0
                                              )),
                            ...
                            if (p !== u) {
                                ...
                                switch (
                                    ...
                                    case "deleteContentBackward":
                                        ...
                                        (v.key = n.keys.Backspace),
                                            f.keydownEvent.call(c, v);
                                        break;
                                    default:
                        ...
                        mouseenterEvent: function () {
                            ...
                            if (
                                ...
                                e.placeholder !== n &&
                                    ...
                                    t.showMaskOnHover &&
                                        (0, s.HandleNativePlaceholder)(i, n);
                            }
                        },
                            ...
                            postValidation: function (e, t, i, a, n, r, o, l) {
                                ...
                                if (
                                    ...
                                    var p = e.slice(
                                        c.targetMatchIndex,
                                        c.targetMatchIndex +
                                            c.targetMatch[0].length
                                    );
                                    if (
                                        (!1 ===
                                            new RegExp(u).test(p.join("")) &&
                ...
                207: function (e, t, i) {
                    ...
                    function f(e, t) {
                        ...
                        for (var a in ("+" === e &&
                            (i = r.seekNext.call(
                                this,
                                t.validPositions.length - 1
                            )),
                        t.tests))
                            if ((a = parseInt(a)) >= i)
                                for (
                                    var n = 0, o = t.tests[a].length;
                                    n < o;
                                    n++
                                )
                                    if (
                    ...
                    function p(e, t) {
                        for (
                            var i = -1, a = 0, n = t.validPositions.length;
                            a < n;
                            a++
                        ) {
                        ...
                        if (
                            (h.forEach(function (e, t) {
                                if (void 0 !== e) {
                                    ...
                                    (a.key = e), (v += e);
                                    var o = r.getLastValidPosition.call(
                                        c,
                                        void 0,
                                        !0
                                    );
                                    !(function (e, t) {
                                        ...
                                        ? (g =
                                              l.EventHandlers.keypressEvent.call(
                                                  c,
                                                  a,
                                                  !0,
                                                  !1,
                        ...
                        (t.analyseMask = function (e, t, i) {
                            ...
                            function x() {
                                if (
                                    ...
                                    if (v.length > 0) {
                                        if (
                                            ((l = v[v.length - 1]).matches.push(
                                                s
                                            ),
                                            l.isAlternator)
                                        ) {
                                            for (
                                                var e = (c = v.pop()).matches[0]
                                                        .matches
                                                        ? c.matches[0].matches
                                                              .length
                                                        : 1,
                ...
                4713: function (e, t, i) {
                    ...
                    function s(e, t, i) {
                        ...
                        if (
                            void 0 !==
                                (t = t || u.call(this, e).match).placeholder ||
                            !0 === i
                        )
                ...
                7215: function (e, t, i) {
                    ...
                    function s(e, t, i, n, o, l) {
                        ...
                        if (
                            ...
                            (c = 0),
                                (u = (d = a.getTest.call(x, c)).alternation);
                        else
                            for (; T >= 0; T--)
                                if (
                                    (p = S.validPositions[T]) &&
                        ...
                        if (void 0 !== u) {
                            ...
                            for (
                                ...
                                for (
                                    S.excludes[m].push(A + ":" + d.alternation),
                                        h = m;
                                    h <
                                    r.getLastValidPosition.call(x, void 0, !0) +
                                        1;
                                    h++
                                )
                                    delete S.validPositions[h];
                        ...
                        return (
                            (O && !1 === w.keepStatic) || delete S.excludes[m],
                            O
                        );
                    }
                    function l(e, t, i) {
                        ...
                        for (var l = e; l < t; l++) {
                            if (
                                ...
                                if (
                                    ...
                                    var u,
                                        p = a.determineTestTemplate.call(
                                            n,
                                            l,
                                            c
                                        );
