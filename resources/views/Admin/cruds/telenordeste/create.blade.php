                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.dashboard.telenordeste.index')}}">Telenordeste</a></li>
                                    <li class="breadcrumb-item active">Cadastro de Telenordeste</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Cadastro de Telenordeste</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
