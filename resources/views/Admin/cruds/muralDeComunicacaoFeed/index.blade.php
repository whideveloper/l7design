                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Mural de comunicação</li>
                                </ol>
                            </div>
                                            ...
                                            <tr data-code="{{$muralDeComunicacaoFeed->id}}">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <a href="{{route('admin.dashboard.muralDeComunicacaoFeed.edit',['muralDeComunicacaoFeed' => $muralDeComunicacaoFeed->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                        </div>
                                                        @endcan
                                                        @can('mural de comunicação.remover')
                                                        <form action="{{route('admin.dashboard.muralDeComunicacaoFeed.destroy',['muralDeComunicacaoFeed' => $muralDeComunicacaoFeed->id])}}" class="col-4" method="POST">
                                                            @method('DELETE') @csrf
