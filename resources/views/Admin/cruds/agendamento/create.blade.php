                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Cadastro de Agendamento</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Cadastro de Agendamento</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                {!! Form::model(null, ['route' => 'admin.dashboard.agendamento.store', 'class'=>'parsley-examples', 'files' => true]) !!}
