                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Treinamento da plataforma</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Treinamento da plataforma</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        @can('treinamento.criar')
                                            @if (!$trainingForUse)
                                                <a href="{{route('admin.dashboard.trainingForUse.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>
                                            @endif                                          
                                        @endcan
                                    </div>
                                    ...
                                    @if ($trainingForUse)
                                        <tbody>
                                            <tr data-code="{{$trainingForUse->id}}">
                                                ...
                                                <td>{{$trainingForUse->title}}</td>

                                                <td class="text-center">
                                                    @switch($trainingForUse->active)
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <a href="{{route('admin.dashboard.trainingForUse.edit',['trainingForUse' => $trainingForUse->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                        </div>
                                                        @endcan
                                                        @can('treinamento.remover')
