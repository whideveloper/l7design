                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Sessão Especialidade</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Sessão Especialidade</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                                    ...
                                    @if (!$especialidadeSession)                                        
                                        <div class="col-6">
                                            @can('especialidade.criar')
                                                <a href="{{route('admin.dashboard.especialidadeSession.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>                                              
                                            @endcan
                                        </div>
                                    @endif
                                        ...
                                        <tbody>
                                            <tr data-code="{{$especialidadeSession->id}}">
                                                ...
                                                <td class="text-center">
                                                    @switch($especialidadeSession->active)
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <a href="{{route('admin.dashboard.especialidadeSession.edit',['especialidadeSession' => $especialidadeSession->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                        </div>
                                                        @endcan
                                                        @can('especialidade.remover')
