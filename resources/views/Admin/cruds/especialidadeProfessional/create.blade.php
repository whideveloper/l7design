        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                {!! Form::model(null, ['route' => 'admin.dashboard.especialidadeProfessional.store', 'class'=>'parsley-examples', 'files' => true]) !!}
                    ...
                    <a href="{{route('admin.dashboard.especialidadeSession.edit', ['especialidadeSession' => $especialidadeSession->id])}}" class="btn btn-secondary waves-effect waves-light float-end me-3 width-lg">Voltar</a>
                {!! Form::close() !!}
            </div> <!-- container -->
        </div> <!-- content -->
    </div>
